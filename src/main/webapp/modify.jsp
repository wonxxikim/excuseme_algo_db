            ...
            <nav class="collapse navbar-collapse mr-1" id="navbarNav">
                <ul class="navbar-nav ms-auto me-2 grid gap-4">
                    <li class = "navbar-item">
                        <a href = "../html/main.html" class="nav-link active fs-5" aria-current="page" href="#">홈</a>
                    </li>
                    <li class = "navbar-item">
                        <a href = "" class="nav-link active fs-5" aria-current="page" href="#">관광지 찾기</a>
                    </li>
                    <li class = "navbar-item">
                        <a href = "" class="nav-link active fs-5" aria-current="page" href="#">게시판</a>
                    </li>
            ...
            <input type="hidden" name="action" value="modify">
                <div class="border shadow rounded mt-5 p-5 col-sm-6 col-md-6 col-lg-4 container centered">
                    <div class="justify-content-center">
                        <label for="newPassword" class="form-label">새 비밀번호</label> <span class="text-warning">*</span>
                        <input type="password" class="form-control mb-2" id="newPassword" name = "userPassword" placeholder="새 비밀번호 입력" required>
                    </div>
                    <div class="justify-content-center">
                        <label for="newEmail" class="form-label">새 이메일</label> <span class="text-warning">*</span>
                ...
                <div class="rounded-top p-0 col-sm-6 col-md-6 col-lg-4 container centered mt-5">
                    <div class="row justify-content-center ms-auto me-auto">
                        <button type="button" class="btn btn-primary" id="updatebtn">정보 수정하기</button>
                    </div>
                </div>
            </form>
    </main>
