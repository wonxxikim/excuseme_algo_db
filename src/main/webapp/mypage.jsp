        ...
        <div class="container centered pt-5 mt-5">
            ...
            <div class="container centered">
                <div class="row justify-content-center p-0 ">
                    <a href = "<%=root%>/user?action=mvmodify" class="w-25 bg-warning" id="updateuser">내 정보 수정</button>
                    <a href = "<%=root%>/user?action=resign" class="w-25 bg-danger" id="deleteuser">내 정보 삭제</button>
                </div>
            </div>
        </div>
